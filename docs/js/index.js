(function(){
    ...
    g.elm.btn_down1 = document.getElementById('btn_up1');
    g.elm.btn_down2 = document.getElementById('btn_up2');
    g.elm.btn_down3 = document.getElementById('btn_up3');
    g.elm.btn_down4 = document.getElementById('btn_up4');
